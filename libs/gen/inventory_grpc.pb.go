...
const (
	Inventory_GetInventory_FullMethodName = "/grpc.inventory.v1.Inventory/GetInventory"
)
...
func (c *inventoryClient) GetInventory(ctx context.Context, in *InventoryRequest, opts ...grpc.CallOption) (*InventoryResponse, error) {
...
func (UnimplementedInventoryServer) GetInventory(context.Context, *InventoryRequest) (*InventoryResponse, error) {
...
func _Inventory_GetInventory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServer).GetInventory(ctx, req.(*InventoryRequest))
	}
...
var Inventory_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.inventory.v1.Inventory",
